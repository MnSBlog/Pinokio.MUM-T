...
namespace Pinokio.Geometry
{
    public static class SweepingVolume
    {
        ...
        public static double Width { get { return _width; } }
        public static double Depth { get { return _depth; } }
        public static double DiagonalLength { get { return _diagonalLength; } }

        public static double LongerLength { get { return _width > _depth ? _width : _depth; } }
