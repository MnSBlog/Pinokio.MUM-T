    ...
    public partial class ViewPort
    {
        ...
        private SnapPoint FindClosestPoint(SnapPoint[] snapPoints)
        {
            ...
            foreach (SnapPoint vertex in snapPoints)
            {
                ...
                Point2D currentScreen = new Point2D(mouseLocation.X, Height - mouseLocation.Y);
        ...
        private void AddAndRefresh(Entity entity, Color color)
        {
        ...
        {
            Point2D gridPoint = new Point2D(System.Math.Round(ptToSnap.X / 10) * 10, System.Math.Round(ptToSnap.Y / 10) * 10);
        ...
        public void DrawCircle(System.Drawing.Point onScreen)
        {
            ...
            for (int angle = 0; angle < 360; angle += 10)
            {
                ...
                x2 = onScreen.X + radius * System.Math.Cos(rad_angle);
                y2 = onScreen.Y + radius * System.Math.Sin(rad_angle);
