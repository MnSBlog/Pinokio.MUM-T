...
{
    partial class EyeshotViewFrame
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.viewPort = new Pinokio._3D.Eyeshot.ViewPort();
            ...
            this.viewPort.gridSnapEnabled = false;
            this.viewPort.Location = new System.Drawing.Point(0, 0);
            this.viewPort.Margin = new System.Windows.Forms.Padding(15);
            this.viewPort.Name = "viewPort";
            this.viewPort.objectSnapEnabled = false;
            this.viewPort.ProgressBar = progressBar1;
            ...
            this.viewPort.Viewports.Add(viewport1);
            this.viewPort.waitingForSelection = false;
            this.viewPort.ErrorOccurred += new devDept.Eyeshot.Environment.ErrorEventHandler(this.viewPort_ErrorOccurred);
            this.viewPort.SelectionChanged += new devDept.Eyeshot.Environment.SelectionChangedEventHandler(this.viewPort_SelectionChanged);
